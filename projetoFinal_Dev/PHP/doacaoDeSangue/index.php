...
<body>
    <header class="header">
        <nav class="nav-container">
            <div class="logo">
                <img src="img/logo_doeSangue_white.png" alt="Logo Doe Sangue">
            </div>
            <ul class="nav-links">
    ...
    <main class="main-content">
        <section id="inicio" class="hero-section">
            ...
            <div class="hero-content">
                <h1 class="hero-title" data-aos="fade-up">Doe Sangue<br><span>Salve Vidas</span></h1>
            ...
            <div class="container">
                <div class="impact-grid">
                    ...
                    <div class="impact-image" data-aos="fade-left">
                        <img src="img/Fauget Express (1).png" alt="Impacto da doação">
                    </div>
                </div>
            </div>
        </section>
